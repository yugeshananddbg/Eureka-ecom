...
// //     dispatch({ type: UPDATE_PROFILE_SUCESS, payload: data.success });
// //   } catch (error) {
// //     dispatch({
...
//       config
//     );
//     dispatch({ type: UPDATE_PASSWORD_SUCESS, payload: data.success });
//   } catch (error) {
//     dispatch({
...
//     dispatch({ type: FORGOT_PASSWORD_SUCESS, payload: data.message });
//   } catch (error) {
//     dispatch({
